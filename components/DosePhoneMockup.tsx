...
/**
 * Right phone — Dose tracking screen (dark theme).
 * Animations:
    ...
    <div ref={ref} className="relative flex items-center justify-center" style={{ height: 680 }}>
      ...
      >
        <div
          ...
          style={{ borderRadius: 40, background: "#081525" }}
        >
          ...
          />
          {/* Status bar */}
          <div className="absolute inset-x-0 top-0 z-[15] flex items-end justify-between px-[22px] pt-[10px] font-display text-[0.66rem] font-semibold text-white/80">
            <span>9:20</span>
          ...
          <div className="h-full overflow-hidden pb-[58px]">
            ...
            >
              ...
              <div className="flex items-center justify-between">
                <span className="font-display text-[0.92rem] font-bold">Dose</span>
                <span
                  className="rounded-full px-3 py-1 text-[0.66rem] font-semibold"
              ...
              {/* Next dose in */}
              <div className="mt-5">
                <h2 className="font-display text-[1.7rem] font-extrabold leading-[1.15] tracking-[-0.02em]">
                  Next dose in<br />
                  <span className="text-[2rem]">12 days</span>
                </h2>
                <p className="mt-1 text-[0.72rem] opacity-60">on Monday, 12 Dec</p>
              </div>
            ...
            <div className="px-[18px] pt-[18px]">
              ...
              >
                <h3 className="font-display text-[0.92rem] font-extrabold text-white tracking-[-0.02em]">
                  Recent logs
                </h3>
                <div className="mt-3 rounded-[14px] overflow-hidden" style={{ background: "rgba(255,255,255,0.04)" }}>
                  {[
                    ...
                    >
                      <div>
                        <div className="text-[0.72rem] font-medium text-white/90">{log.date}</div>
                        <div className="text-[0.6rem] text-white/40">{log.drug}</div>
                      </div>
          ...
          {/* Bottom tab bar — dark variant */}
          <nav
            className="absolute inset-x-0 bottom-0 flex justify-around px-[6px] pb-[10px] pt-2"
            style={{ borderTop: "1px solid rgba(255,255,255,0.06)", background: "#081525" }}
          >
            {[
              { label: "Home", icon: "⌂" },
              ...
              <div
                ...
                style={{ color: tab.active ? "white" : "rgba(255,255,255,0.35)" }}
              >
                {tab.isOrb ? (
                  <motion.span
